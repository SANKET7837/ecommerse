    ...
    <header className="bg-gray-100 shadow-lg">
      <div className="container mx-auto flex flex-wrap items-center justify-between p-4">
        ...
        <nav className="flex flex-wrap items-center space-x-4 md:space-x-6 mb-4 md:mb-0">
          ...
          <a href="/shirts" className="text-gray-600 hover:text-gray-900 text-sm">
            Shirts
          </a>
          <a href="/sticker" className="text-gray-600 hover:text-gray-900 text-sm">
            Stickers
          </a>
        </nav>
        ...
        <div className="flex flex-wrap items-center space-y-2 md:space-y-0 md:space-x-2 mb-4 md:mb-0 w-full md:w-auto">
          ...
          />
          <button className="w-full md:w-auto bg-blue-500 px-4 py-2 text-sm text-white rounded-md hover:bg-blue-600">
            Search
          </button>
        </div>
