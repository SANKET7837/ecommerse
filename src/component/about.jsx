	...
	return (
		<div className="px-6 py-8">
			...
			<p className="font-sans text-lg text-gray-700 mb-6 leading-relaxed">
				...
				<a href="/next.js" className="text-blue-500 hover:underline">
					Next.js Commerce
				</a>
				, which is an ecommerce template for creating a headless Shopify
				storefront.
			</p>
			...
			<div className="mb-6">
				...
				<ul className="list-disc pl-6 space-y-2 font-sans text-gray-700 text-base">
					...
					<li>
						<a
							href="https://example.com/hidden-products"
					...
					<li>
						Dynamically driven content and features via Shopify (i.e.,
