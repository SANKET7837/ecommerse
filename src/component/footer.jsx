      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">
        ...
        <div className="flex items-center mb-4 lg:mb-0">
          <img
            ...
            alt="ACME Store Logo"
          />
          <h1 className="ml-2 text-sm font-bold text-gray-800">
            ACME STORE
          </h1>
        </div>
        ...
        <div>
          <button className="flex items-center px-4 py-2 border border-gray-300 text-gray-600 rounded-md hover:bg-gray-100 font-bold">
